    ...
    createClient = () => {
        if (!this.validateEmail(this.state.email)) {
            ...
            var datas = {
                ...
                'local_adress': this.state.local_address,
                ...
                'aadhar_card': this.state.adhar_resourcePath.data,
                'passport': this.state.profile_resourcePath.data,
                'licence': this.state.licence_resourcePath.data,
                'voter_id': this.state.vater_resourcePath.data,
                'pan_card': this.state.pancard_resourcePath.data,
                // }],
                // "kwargs": {},
                // "method": "create_contact_mobile",
                // "model": "res.partner"
            };
            this.props.navigation.navigate('AddMoreAttach', {
                datas: datas,
            });
  ...
  /> */}
              ...
              placeholderTextColor="#003f5c" /> */}
                                ...
                                <View>
                                    {renderIf(this.state.profile_resourcePath.data,
                                        ...
                                        <View style={{ flexDirection: 'row', alignContent: 'stretch' }}>
                                            ...
                                            <TouchableOpacity style={{ width: '40%', textAlignVertical: 'center' }}>
                    ...
                    >
                                            ...
                                            <TouchableOpacity style={{ width: '40%', textAlignVertical: 'center' }}>
                                                <Icon onPress={this.clearPancardFile}
                                                    name="trash"
                                                    color="#fb5b5a"
                                                    size={35}>
                                                </Icon>
          ...
          /> */}
                            <TouchableOpacity style={submitBtn} onPress={() => this.createClient()}>
                                <Text style={submitBtnText}>Next</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </ScrollView>
